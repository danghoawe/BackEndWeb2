<div class="navbar-custom">
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown d-none d-lg-block">
            <a class="nav-link dropdown-toggle mr-0 waves-effect" data-toggle="dropdown" href="#" role="button"
                ...
                <img src="admin_asset/assets\images\flags\us.jpg" alt="user-image" class="mr-2" height="12"> <span
                    class="align-middle">English <i class="mdi mdi-chevron-down"></i> </span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="admin_asset/assets\images\flags\germany.jpg" alt="user-image" class="mr-2" height="12"> <span
                        class="align-middle">German</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="admin_asset/assets\images\flags\italy.jpg" alt="user-image" class="mr-2" height="12"> <span
                        class="align-middle">Italian</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="admin_asset/assets\images\flags\spain.jpg" alt="user-image" class="mr-2" height="12"> <span
                        class="align-middle">Spanish</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="admin_asset/assets\images\flags\russia.jpg" alt="user-image" class="mr-2" height="12"> <span
                    ...
                    <div class="inbox-widget">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="admin_asset/assets\images\users\avatar-1.jpg"
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="admin_asset/assets\images\users\avatar-2.jpg"
                                        class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="admin_asset/assets\images\users\avatar-3.jpg"
                                        class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="admin_asset/assets\images\users\avatar-4.jpg"
                                        class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="admin_asset/assets\images\users\avatar-5.jpg"
                                        class="rounded-circle" alt=""></div>
    ...
    <div class="logo-box">
        <a href="index.html" class="logo text-center logo-dark">
            <span class="logo-lg">
                <img src="admin_asset/assets\images\logo-dark.png" alt="" height="18">
                <!-- <span class="logo-lg-text-dark">Velonic</span> -->
            </span>
            <span class="logo-sm">
                <!-- <span class="logo-lg-text-dark">V</span> -->
                <img src="admin_asset/assets\images\logo-sm.png" alt="" height="22">
            </span>
        </a>

        <a href="index.html" class="logo text-center logo-light">
            <span class="logo-lg">
                <img src="admin_asset/assets\images\logo-light.png" alt="" height="18">
                <!-- <span class="logo-lg-text-dark">Velonic</span> -->
            </span>
            <span class="logo-sm">
                <!-- <span class="logo-lg-text-dark">V</span> -->
