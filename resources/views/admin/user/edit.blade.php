                            ...
                            <form class="parsley-examples" action="#">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="userName" parsley-trigger="change" required=""
                                        placeholder="Enter user name" class="form-control" value="{{$user->username}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstName" parsley-trigger="change" required=""
                                        placeholder="Enter First Name" class="form-control" value="{{$user->fristName}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" parsley-trigger="change" required=""
                                        placeholder="Enter email" class="form-control" value="{{$user->Email}}">
                                </div>

                                <div class="form-group">
                                    <label for="birthDay">BirthDay<span class="text-danger">*</span></label>
                                    <input type="text" name="birthDay" parsley-trigger="change" required=""
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="numberPhone" parsley-trigger="change" required=""
                                        placeholder="Enter Number Phone" class="form-control" value="{{$user->Numberphone}}">
                                </div>
