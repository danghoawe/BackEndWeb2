...
<body>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="./"><img src="{{ URL::asset('img/vertu.jpg')}}"></a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{ URL::asset('shoppage') }}">Shop page</a></li>
    ...
    <div class="maincontent-area">
        ...
        <!-- Slider -->
        <script type="{{ URL::asset('text/javascript')}}" src="{{ URL::asset('js/bxslider.min.js')}}"></script>
        <script type="{{ URL::asset('text/javascript')}}" src="{{ URL::asset('js/script.slider.js')}}"></script>
</body>
