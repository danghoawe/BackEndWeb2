                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="CMND" type="text" class="form-control @error('CMND') is-invalid @enderror" name="CMND" required autocomplete="CMND" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="numberPhone" class="col-md-4 col-form-label text-md-right">Number Phone</label>

                            <div class="col-md-6">
                                <input id="numberPhone" type="text" class="form-control @error('numberPhone') is-invalid @enderror" name="numberPhone" required autocomplete="numberPhone" autofocus>
